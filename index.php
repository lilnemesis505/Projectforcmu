...
<body>
    ...
    <nav class="navbar">
        <div class="logo">
            <a href="index.php" style="text-decoration: none; color: inherit;">CMU X ACADEMY</a>
        </div>
        <ul class="nav-links">
            <li><a href="index.php">หน้าหลัก</a></li>
            <li><a href="#">สมาชิก</a></li>
            <li><a href="#">สิธิพิเศษ</a></li>
    ...
    <div class="container">
       ...
       <section class="banner-section">
            <div class="main-banner">
                <img src="https://4kwallpapers.com/images/walls/thumbs_3t/14776.jpg" alt="Main Banner">
            </div>
            
            <div class="side-banners"> 
                <img src="https://4kwallpapers.com/images/walls/thumbs_3t/14776.jpg" alt="Side Banner 1">
                <img src="https://4kwallpapers.com/images/walls/thumbs_3t/14776.jpg" alt="Side Banner 2">
            </div>
